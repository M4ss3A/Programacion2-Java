...
public class Main {
    public static void main(String[] args) {
        ...
        // 1) Crear el inventario (ArrayList vacio)
        ...
        // 4) Buscar por ID y mostrar
        System.out.println("\n=== 4) Buscar producto por ID '003' ===");
        ...
        inv.actualizarStock("002", 15); // tu método imprime el resultado internamente
        ...
        System.out.println("\n=== 9) Filtrar por categoria: ALIMENTOS ===");
        ...
        System.out.println("\n=== 10) Filtrar por precio entre $1.000 y $3.000 ===");
        ArrayList<Producto> rango = inv.filtrarProductosPorPrecio(1000, 3000);
        imprimirLista(rango);

        // 11) Mostrar categorias disponibles (recorre el enum)
        System.out.println("\n=== 11) Categorias disponibles ===");
